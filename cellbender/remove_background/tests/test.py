...
class TestConsole(unittest.TestCase):
    ...
    def test_data_simulation_and_write_and_read(self):
        """Run a basic tests of data simulation and read and write functionality.
        ...
        try:
            ...
            # This is here to suppress the numpy warning triggered by scipy.sparse.
            ...
            barcode_names = np.array([f'bc_{i}' for i in
            ...
            write_matrix_to_h5(temp_file_name,
                               ...
                               inferred_count_matrix=csr_barcode_gene_synthetic.tocsc(),
    ...
    def test_inference(self):
        ...
        try:
            ...
            z, d, p = cellbender.remove_background.model.get_encodings(inferred_model,
                                                                       dataset_obj)
...
def main():
    ...
    # TODO: the intended unittest framework is not being used properly
    # unittest_main(module='cellbender.remove_background',
    #               verbosity=0, exit=False)
